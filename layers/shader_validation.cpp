...
struct shader_moudle_used_operators {
    bool updated;
    ...
    shader_moudle_used_operators() : updated(false) {}
...
static void IsSpecificDescriptorType(SHADER_MODULE_STATE const *module, const spirv_inst_iter &id_it, bool is_storage_buffer,
                                     ...
                                     shader_moudle_used_operators &used_operators) {
    ...
    switch (type.opcode()) {
        case spv::OpTypeImage: {
            ...
            if (dim != spv::DimSubpassData) {
                ...
                if (CheckObjectIDFromOpLoad(id, used_operators.sampler_implicitLod_members, used_operators.load_members,
                                            used_operators.accesschain_members)) {
                    out_interface_var.is_sampler_implicitLod = true;
                }
...
std::vector<std::pair<descriptor_slot_t, interface_var>> CollectInterfaceByDescriptorSlot(
    ...
    shader_moudle_used_operators operators;
